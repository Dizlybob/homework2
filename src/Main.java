public class Main {
    public static void main(String[] args) {
        ...
        worker = worker + 94;
        var hoursPerWorker = hours / worker;
        System.out.println("Если в компании работает " + worker + " человек, то всего " + hoursPerWorker + " часов работы может быть поделено между сотрудниками.");
    }
}